%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%               Solving 2-D wave equation with 7th order
%             Weighted Essentially Non-Oscilaroty (WENO7)
%
...
a=0; b=1; c=0; d=1; [x,dx,y,dy]=grid2d(a,b,nx,c,d,ny);
...
for tstep=t
    ...
    if(rem(it,10)==0)
        ...
        title(['WENO7, dx = ',num2str(dx),', dy = ',num2str(dy),', time: ',num2str(tstep)])

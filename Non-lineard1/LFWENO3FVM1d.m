%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%              Solving 1-D wave equation with 3rd order
%             Weighted Essentially Non-Oscilaroty (WENO3)
%
...
% lines (MOL) using WENO3 associated with SSP-RK33 time integration method. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while t < tEnd
    ...
    % 1st stage
    dF = WENO3resAdv1d(u,flux,dflux,S,dx);
    u = uo-dt*dF;
